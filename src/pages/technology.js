...
function technology() {
  return (
    ...
    {/*---------------------Main Header----------------------- */}
        <Title data-bs-spy="scroll" data-bs-target="#nav-sections" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" id="Top" className='main-header'>
            <div className="content-wrapper">
                <div className="text-wrapper container">
                    <h1 id="mainText">Our Tech</h1>
                </div>
    ...
    {/* -------------------Navigation Bar ---------------------- */}
        <Navbar id="nav-sections" className="navbar" style={{position:'sticky', top:'0'}}>
                <ul className="nav nav-pills">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="#section-2">Blockchain</a>
                    </li>
                </ul>
        </Navbar>
    {/* ----------------------------------------------------------------------------------- */}
        <Section style={{background:'white'}}>
            <h1 className='container text-center reveal active'
            style={{color:'black'}}>
            ...
            <Title>
                <div className="content-wrapper">
                    <div className="container text-wrapper container">
                            ...
                            blockchain-based digital forensics technology to publically authenticate
                            the origin of stories from the field 
                            </p>
                    </div>
                    <StaticImage style={{position:"absolute"}} src="../images/technology/Record-2.jpeg" className="backgroundImg"/>
                </div>
            </Title>
            <Cards style={{background:'#E512D0'}}>
                <div className="container">
                <h2 className="h2Section">How We Capture & Fact Check Content:</h2>
                    <div className="cards" style={{display:"flex"}}>
                        <div className="text-card" style={{background:'white', borderRadius:'1rem', textAlign:'center'}}>
                        ...
                        <div className="text-card" style={{background:'white', borderRadius:'1rem'}}>
                            <h3>Blockchain Record</h3>
                            <p>
                                <br/>
                                The content is recorded using public ledger technology, making its origin 
                                accessible to newswire subscribers & partners 
                            </p>
                        </div>
                        <div className="text-card" style={{background:'white', borderRadius:'1rem'}}>
            ...
            <Section>
                <div className='content-wrapper'>
                        <div className="inner text-wrapper reveal active contactUs">
                            ...
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLScpXPlS3MOqr9-P5E4A_F2JFt4dfspI-OY2W-xlAPWUOT9yoA/viewform" target="blank">
                                <button className="btn btn-primary">
                                    Contact Us Today
                                </button>
                            </a>
                        </div>
                        <StaticImage style={{position:"absolute"}} src="../images/technology/DownloadApp.jpeg" className="backgroundImg"/>
                </div>
            </Section>
    {/* ----------------------------Blockchain-----------------------------*/}
            ...
            <Title id="section-2">
                <div className="content-wrapper" /*style={{height:"70vh"}}*/>
                    <div className="text-wrapper text-reveal container">
                        <h1 className='reveal active'>How Blockchain Is Used</h1>                    
                    </div>
                    <StaticImage style={{position:"absolute"}} src="../images/technology/Blockchain-orange.jpeg" className="backgroundImg"/>
                </div>
            </Title>
            <Section>
                <div className="blockchainTxt"style={{background:'black'}}>
                    <div className='container'>
                        <h2>
                            We use public ledger technology to craft transparent records of exactly where, when,
                            and how digital content originates in order to better combat misinformation.
                        </h2>
                    </div>
                </div>
            </Section>
            <Cards style={{background:'white'}}>
                <div className='container'>
                    <h2 className="magenta">How That Works: </h2>
                    <div className='cards'>
                        <div className='text-card' style={{background:'#D9D9D9',borderRadius:'1rem'}}>
                        ...
                        <div className='text-card' style={{background:'#D9D9D9',borderRadius:'1rem'}}>
                            ...
                            <p>
                                This record is posted to the blockchain and a receipt is generate
                                showing the location of data and what is posted
                            </p>
                        </div>
                        <div className='text-card' style={{background:'#D9D9D9',borderRadius:'1rem'}}>
    ...
    <Section style={{background:'#1EE4F0'}}>
        <div className='container'>
            <h1  className="cyan">Get Access To More Verified Insights On Your Area: </h1>
                <a href="https://docs.google.com/forms/d/e/1FAIpQLScpXPlS3MOqr9-P5E4A_F2JFt4dfspI-OY2W-xlAPWUOT9yoA/viewform" target="blank">
...
//---------------------------------MEDIA QUERIES---------------------------------
    ...
    @media(max-width: 27rem){
        ...
        .text-card > p { margin-top:1rem; font-weight: 300;}
        .magenta{ 
            font-size:2.5rem;
            text-align:center;
            margin: 0 auto;
