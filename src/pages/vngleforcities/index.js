        ...
        <MainPageContainer>
            ...
            <Col md={6}>
              <div className="content p-md-5">
                ...
                <Heading>
                  ...
                  deeper connection and representation for your area.
                </Heading>
              </div>
            </Col>
          ...
          <Section className="p-md-5">
            <Heading weight="500" lineHeight="1.3em">
              Substantive local impact comes from grassroots up approaches, not
              top down thinking.{" "}
              <b>
                Whether it's in business, politics, or any field, organizations
                must stay in touch with locals to avoid blind spots in their
                decisions.
              </b>
            </Heading>
            <Heading weight="500" lineHeight="1.3em">
              We help organizations overcome local echo chambers to view the
              needs of communities and build an authentic presence among them.
            </Heading>
          </Section>
          ...
          <SplitSection background="#3cf" className="gy-3">
            <Col md={6}>
              <div className="content p-md-5">
                ...
                <p>
                  Our coverage helps organizations stay connected and build
                  their presence in the cities they care about. We can work with
                  your media team or you can outsource your media needs to us
                  and we’ll create an engaging grassroots content strategy to
                  help you stay connected to, and have a presence among the
            ...
            <Col md={{ span: 6, order: "last" }}>
              <div className="content p-md-5">
                ...
                <p>
                  ...
                  shifting environment around your local area. Think of us as
                  your localized census service: we craft and deploy strategic
                  field plans to reach local areas directly to gain or relay
                  updated information.
                </p>
                <Button
                  size="lg"
            ...
            <Col md={6}>
              <div className="bg-primary content position-relative d-flex flex-column justify-content-center">
                ...
                <div className="d-flex justify-content-center">
                  <StaticImage
                    src="../../images/vngleforcities/cp-logo.png"
