...
const MainPage = () => {
  return (
    <MainPageContainer>
      <SplitSection background="var(--bs-primary)">
      ...
      <SplitSection background="#3cf">
        <Col className="content" md={6}>
          ...
          <p>
            ...
            presence in the cities they care about. We can work with your media
            team or you can outsource your media needs to us and we’ll create an
      ...
      <SplitSection background="#ff52db">
        <Col className="content" md={6} xs={{ order: "last" }}>
          ...
          <p>
            Through Engage, Vngle keeps your finger on the pulse of the shifting
            environment around your local area. Think of us as your localized
      ...
      <SplitSection background="var(--bs-primary)">
        <Col className="content" md={6}>
          ...
          <Heading>
            Get research and consultation on how to address unique concerns that
            matter most to your city.
          </Heading>
          <p>
            With Vngle Insights, we listen carefully to your city to ensure
            everyone’s voices are heard, to get you the data needed to make the
            best decisions. Our insights make you aware of the matters that are
            important to constituents. We offer you our grassroots knowledge
